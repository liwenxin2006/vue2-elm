...
##   $ docker build -t java-for-liwenxin2006-vue2-elm .
##
## RUNNING
##   $ docker run java-for-liwenxin2006-vue2-elm

FROM gcr.io/bitnami-containers/minideb-extras:jessie-r12

MAINTAINER Bitnami <containers@bitnami.com>

ENV STACKSMITH_STACK_ID="pwjk95u" \
    STACKSMITH_STACK_NAME="Java for liwenxin2006/vue2-elm" \
